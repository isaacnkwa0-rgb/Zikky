    ...
    <>
      ...
      >
        <svg viewBox="0 0 24 24" fill="white" width="28" height="28" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M12 0C5.373 0 0 5.373 0 12c0 2.124.558 4.126 1.535 5.862L.057 23.428a.75.75 0 0 0 .916.916l5.566-1.478A11.942 11.942 0 0 0 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.75a9.712 9.712 0 0 1-4.953-1.355l-.355-.211-3.684.977.978-3.576-.228-.367A9.712 9.712 0 0 1 2.25 12C2.25 6.615 6.615 2.25 12 2.25S21.75 6.615 21.75 12 17.385 21.75 12 21.75z"/>
        </svg>
      </a>
    </>
  );
